...
public class OlarkChatPlugin : BasePlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        {
            SiteId = "9930-373-10-1373", WidgetPosition = "right", EnableMobile = true
        };
    ...
    public IDictionary<string, string> GetPluginResources()
    {
        var list = new Dictionary<string, string>
        {
            ...
            ["plugins.widgets.olarkchat.basic"] = "Select options",
            ["plugins.widgets.olarkchat.advanced"] = "Paste script",
            ["plugins.widgets.olarkchat.customscript"] = "Custom script",
            ["plugins.widgets.olarkchat.customscript.Hint"] = "Paste your custom script",
        };
